...
```bash
pi
/login  # Then select Anthropic and choose subscription or Console billing
```
...
**Subscriptions / OAuth-backed access:**
- Anthropic Claude subscription or Console billing
